...
/**
  ...
  * @param  USART_WordLength : This parameter can be any of the @ref USART_WordLength_TypeDef enumeration.
  * @param  USART_StopBits : This parameter can be any of the @ref USART_StopBits_TypeDef enumeration.
  * @param  USART_Parity : This parameter can be any of the @ref USART_Parity_TypeDef enumeration.
  * @param  USART_Mode : This parameter can be any of the @ref USART_Mode_TypeDef values
  * @retval None
  * @par    Required preconditions:
  *   Configure in Push Pull or Open Drain mode the Tx pin by setting the correct
  *   I/O Port register according the product package and line configuration
  */
...
/**
  ...
  * @param  USARTx : where x can be 1 to select the specified USART peripheral.
  * @param  USART_Clock : This parameter can be any of the @ref USART_Clock_TypeDef enumeration.
  * @param  USART_CPOL : This parameter can be any of the @ref USART_CPOL_TypeDef enumeration.
  * @param  USART_CPHA : This parameter can be any of the @ref USART_CPHA_TypeDef enumeration.
  * @param  USART_LastBit : This parameter can be any of the @ref USART_LastBit_TypeDef enumeration.
  * @retval None
  */
...
/**
  ...
  *       operation to USART_SR register (USART_GetITStatus()) followed by a read
  *       operation to USART_DR register (USART_ReceiveData8() or USART_ReceiveData9()).
  *
  *     - RXNE pending bit can be also cleared by a read to the USART_DR register
  *       (USART_ReceiveData8() or USART_ReceiveData9()).
  *
  *     - TC (Transmit complet) pending bit can be also cleared by software sequence: a read
  *       operation to USART_SR register (USART_GetITStatus()) followed by a write
  *       operation to USART_DR register (USART_SendData8()or USART_SendData9()).
  *

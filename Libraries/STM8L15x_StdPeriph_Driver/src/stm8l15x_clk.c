...
/**
  ...
  *   In case of Enabling HSE Bypass be sure that SWI, CKM and Clock RTC are not
...
/**
  ...
  * @retval None
  * @par Required preconditions:
  *  In case of Enabling LSE ByPass be sure that SWI, CKM and Clock RTC are not
  *  using LSE as clock source
  */

...
static void TI1_Config(TIM1_ICPolarity_TypeDef TIM1_ICPolarity, TIM1_ICSelection_TypeDef TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
static void TI2_Config(TIM1_ICPolarity_TypeDef TIM1_ICPolarity, TIM1_ICSelection_TypeDef TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
static void TI3_Config(TIM1_ICPolarity_TypeDef TIM1_ICPolarity, TIM1_ICSelection_TypeDef TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
static void TI4_Config(TIM1_ICPolarity_TypeDef TIM1_ICPolarity, TIM1_ICSelection_TypeDef TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
...
/**
  ...
  * @param  TIM1_OCMode specifies the Output Compare mode  from @ref TIM1_OCMode_TypeDef.
  * @param  TIM1_OutputState specifies the Output State  from @ref TIM1_OutputState_TypeDef.
...
/**
  ...
  * @param  TIM1_BreakPolarity specifies the Break polarity from @ref TIM1_BreakPolarity_TypeDef.
  * @param  TIM1_AutomaticOutput specifies the Automatic Output configuration from @ref TIM1_AutomaticOutput_TypeDef.
  * @retval None
  */
...
/**
  ...
  * @param  TIM1_Channel specifies the input capture channel from @ref TIM1_Channel_TypeDef.
  * @param  TIM1_ICPolarity specifies the Input capture polarity from  @ref TIM1_ICPolarity_TypeDef .
  * @param  TIM1_ICSelection specifies the Input capture source selection from @ref TIM1_ICSelection_TypeDef.
  * @param  TIM1_ICPrescaler specifies the Input capture Prescaler from @ref TIM1_ICPSC_TypeDef.
...
/**
  ...
  * @param  NewState new state of the TIM1 peripheral. This parameter can
...
/**
  ...
  *   This parameter can be any combination of the @ref TIM1_IT_TypeDef enumeration.
  * @param  NewState new state of the TIM1 peripheral.
  * @retval None
  */
...
/**
  * @brief  Configures the TIM1x’s DMA interface.
...
/**
  ...
  *   This parameter can be one of the @ref TIM1_EventSource_TypeDef enumeration.
  * @retval None
  */

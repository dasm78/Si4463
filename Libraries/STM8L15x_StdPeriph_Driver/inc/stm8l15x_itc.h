...
typedef enum {
  ...
  SWITCH_CSS_BREAK_DAC_IRQn      = (uint8_t)17,  /*!< Ck switch/CSS interrupt/TIM1 Break /DAC  interrupt */
  ...
  TIM2_CAP_IRQn                  = (uint8_t)20,  /*!< TIM2 input captute/output compare interrupt  */
  TIM3_UPD_OVF_TRG_BRK_IRQn      = (uint8_t)21,  /*!< TIM3 TIM3 Update/Overflow/Trigger/Break interrupt */
  ...
  TIM1_CAP_IRQn                  = (uint8_t)24,  /*!< TIM1 input captute/output compare interrupt  */
